...
function PlusIcon(props) {
  return (
    <div class="border rounded-lg bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500">
    <svg
      ...
      {...props}
    >
      <title id="Add more Button">Click to add a new Art</title>
      <defs>
      ...
      >
        ...
        <text fill="rgba(255, 255, 255, 1)" transform="translate(252 270)">
          <tspan x={0} y={0}>
            {"Add"}
          </tspan>
        </text>
